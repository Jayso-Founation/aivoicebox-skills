...
def on_message(client, userdata, msg):
    ...
    if msg.topic == _SUB_INTENT_ON_SUCCESS:
        ...
        if intent == "news":
            ...
            news = nlu_payload["slots"][0]["rawValue"]

            news_data = json.loads(requests.get("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=4f4fa67aa2cb48619e7bdf98a7bb080f").content)
            news_d = news_data['articles'][0]['title']
            print(news_d)
            sentence = "AAJ KI TAAZA KHABAR " + news_d 
